...
>* Ewen Gallic: [`R` and programming](http://egallic.fr/Enseignement/R/m1_stat_eco_logiciel_R.pdf) (in French)
>* Hadley Wickham & community: [doc ggplot2](http://docs.ggplot2.org/dev/)

# ggplot2

![](img/03_ggplot2_overview.jpg)
...
In the lower right panel: Packages > Install

`ggplot2` is integrated in the brand new `tidyverse` package (contains other useful libraries you will learn to use)
