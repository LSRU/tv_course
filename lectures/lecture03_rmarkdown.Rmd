...
## Markdown | Most common text formatting **tags** are defined
...
### Verbatim code{.box-6 .bg-blue .stretch .build .my-code} 
...
## Rmarkdown document | Create, step 1{.maximise}

###{.col-10 .offset-1}

![](img/03_rstudio_rmd_create_1.jpg)

## Rmarkdown document | Create, step 2{.maximise}
...
## Rmarkdown document | Navigation{.maximise}
