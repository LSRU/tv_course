...
The goal is to learn statistics applied to biology using ![](./img/Rlogo_90.png)
...
- Day 1 -- Session 3
    + Preparation for Bring your own data session (see Day 4 )
