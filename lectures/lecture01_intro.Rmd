...
### Why R is hard to learn {.bg-yellow .box .col-11}
...
source: [Robert A. Muenchen' blog](http://r4stats.com/articles/why-r-is-hard-to-learn/)
...
source: [rdocumentation](https://www.rdocumentation.org/trends) (2017/04/18)
...
<span class="xx-small">source: [rdocumentation](https://www.rdocumentation.org/trends) (2017/04/18)</span>
...
### Conflicts! when 2 packages export a function {.col-6 .box .bg-red}
...
### **Solution** using the `::` operator to call a function from a specific package {.box .col-10 .offset-1 .bg-green}
