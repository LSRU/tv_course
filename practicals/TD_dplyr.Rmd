...
(@) Extract the processed pseudogenes from the `genes_by_exon` data set. Use `glimpse()` to find the correct columns and `distinct()` to identify how pseudogenes are coded.
```{r, solution = TRUE}
  gene_by_exon %>% 
