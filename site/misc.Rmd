...
replace <kbd>Cmd</kbd> by <kbd>Ctrl</kbd> for PC

- Scripting 
    + <kbd>Alt</kbd> + <kbd>-</kbd>: insert <kbd> <- </kbd>
...
- [ggplot2 - book](https://www.amazon.com/ggplot2-Elegant-Graphics-Data-Analysis/dp/331924275X/ref=dp_ob_title_bk) by Hadley
```{r, echo = FALSE, out.width='10%', fig.align = 'right'}
knitr::include_graphics("https://images-na.ssl-images-amazon.com/images/I/31ymj6YEOIL._SX328_BO1,204,203,200_.jpg")
```
- [Rmarkdown](http://rmarkdown.rstudio.com/) by Rstudio
- [Advanced in R](http://adv-r.had.co.nz/) by Hadley
```{r, echo = FALSE, out.width='10%', fig.align = 'right'}
knitr::include_graphics("https://images-na.ssl-images-amazon.com/images/I/41Qkod8KOBL._SX329_BO1,204,203,200_.jpg")
```
...
- Excellent and free ressource about `R` (in **French**) by [Ewen Gallic](http://egallic.fr/Enseignement/R/m1_stat_eco_logiciel_R.pdf)
