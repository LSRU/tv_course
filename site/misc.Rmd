...
- `# analysis step ####` for navigating in your then tagged code
- Running
...
- [Introduction to data science and statistical programming with R](https://leanpub.com/datascience_and_R) by [Thomas Mailund](http://www.mailund.dk/) ([free text on github](https://github.com/mailund/introduction-to-data-science))
```{r, echo = FALSE, out.width='10%', fig.align = 'right'}
